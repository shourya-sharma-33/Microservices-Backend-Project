...
import { okRes, badRequestRes, unauthorizedRes, notFoundRes } from "../config/res_handler.js";
...
export const userProfile = try_catch(async (req, res) => {
    const user = req.user;
    res.json(user);
});
export const updateUserName = try_catch(async (req, res) => {
...
export const getAllUsers = try_catch(async (req, res) => {
